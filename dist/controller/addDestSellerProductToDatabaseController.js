...
const AddProductToDatabaseController = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, price, currency, category, model, shortDescription, longDescription, features, ratings, coverageArea, specialFeature, images, availability, discountState, discountAmount } = request.body;
    ...
    try {
        const saveProductDetails = new product_schema_1.bestSellerProductModel(productObject);
