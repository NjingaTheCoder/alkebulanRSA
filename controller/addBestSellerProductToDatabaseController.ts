...
const addBestSellerProductToDatabaseController = async (request :Request , response : Response) => {
    ...
    try{
            const saveProductDetails = new bestSellerProductModel(productObject);
...
export default addBestSellerProductToDatabaseController;
